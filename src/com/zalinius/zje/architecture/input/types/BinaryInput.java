...
public enum BinaryInput {
	...
	KEY_OPENBRACKET(KeyEvent.VK_OPEN_BRACKET),
	KEY_CLOSEBRACKET(KeyEvent.VK_CLOSE_BRACKET),
	KEY_MINUS(KeyEvent.VK_MINUS),
	KEY_EQUALS(KeyEvent.VK_EQUALS),
	KEY_BACKTICK(KeyEvent.VK_BACK_QUOTE),
	...
	BUTTON_DPAD_UP(SDL.SDL_CONTROLLER_BUTTON_DPAD_UP + Inputtable.BUTTON_OFFSET),
	BUTTON_DPAD_DOWN(SDL.SDL_CONTROLLER_BUTTON_DPAD_DOWN + Inputtable.BUTTON_OFFSET),
	BUTTON_DPAD_LEFT(SDL.SDL_CONTROLLER_BUTTON_DPAD_LEFT + Inputtable.BUTTON_OFFSET),
	BUTTON_DPAD_RIGHT(SDL.SDL_CONTROLLER_BUTTON_DPAD_RIGHT + Inputtable.BUTTON_OFFSET),
	;
